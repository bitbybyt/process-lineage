...
async function link() {
	...
	const bill5 = await Bill.findOne({ customerName: 'Dummy 1' }); 
	const bill6 = await Bill.findOne({ customerName: 'Tom Avery' });
	const bill7 = await Bill.findOne({ customerName: 'Dummy 2' });
	const bill8 = await Bill.findOne({ customerName: 'Dummy 3' });
	const bill9 = await Bill.findOne({ customerName: 'Dummy 4' });
	const bill10 = await Bill.findOne({ customerName: 'Dummy 5' });
	const bill11 = await Bill.findOne({ customerName: 'Dummy 6' });
